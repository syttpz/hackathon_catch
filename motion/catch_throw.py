...
from motion.track_red import locate_target, estimate_distance, DirectArmMove, camera_tilt_deg
...
def main():
    ...
    parser.add_argument('--config', type=Path, default=Path(__file__).parents[1]/'catch_throw.config.json')
