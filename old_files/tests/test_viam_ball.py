...
from old_files.red_ball.vision.viam_ball import (
...
class ViamBallTests(unittest.IsolatedAsyncioTestCase):
    async def test_reads_gripper_tcp_in_world_without_motion(self):
        ...
        with patch("old_files.red_ball.vision.viam_ball.MotionClient.from_robot", return_value=motion):
    ...
    async def test_detect_selects_highest_confidence_ball_and_midpoint(self):
        ...
        with patch("old_files.red_ball.vision.viam_ball.VisionClient.from_robot", return_value=service):
