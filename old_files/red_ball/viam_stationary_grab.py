...
from old_files.red_ball.vision.viam_ball import BallPose, ball_pose_in_world, detect_ball


_cycle_lock = asyncio.Lock()
DEFAULT_CONFIG = Path(__file__).with_name("stationary_grab.config.json")
