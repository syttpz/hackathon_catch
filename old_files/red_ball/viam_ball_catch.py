...
Preview (default) never moves. --execute opens the gripper and intercepts.
  ...
  python -m old_files.red_ball.viam_ball_catch
  python -m old_files.red_ball.viam_ball_catch --execute
"""
import argparse
import asyncio
import json
...
from old_files.red_ball.vision.viam_ball import BallDetection, BallPose, ball_pose_in_world

DEFAULT_CONFIG = Path(__file__).with_name("ball_catch.config.json")
