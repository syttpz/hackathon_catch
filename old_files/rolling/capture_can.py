...
from old_files.rolling.rolling_preview import table_plane,locate_object
from old_files.rolling.rolling_intercept import RollingFit
from old_files.rolling.rolling_catch import prepare_gripper
from motion.live_camera_pose import PoseBuffer,sample_camera,pose_matrix
from old_files.rolling.can_follower import LatestMove,next_target,can_grab,start_pose,move_to_start
...
def main():
    ...
    parser.add_argument('--config',type=Path,default=Path(__file__).with_name('can_follow.config.json'))
