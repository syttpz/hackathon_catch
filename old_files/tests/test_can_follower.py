...
from old_files.rolling.can_follower import LatestMove,next_target,visible,can_grab,start_pose,move_to_start

CONFIG=json.loads((Path(__file__).parents[1]/'rolling'/'can_follow.config.json').read_text())
