"""Read-only ball tracking: python -m old_files.red_ball.trajectory_rolling --hz 60.
...
from old_files.red_ball.viam_ball_catch import DEFAULT_CONFIG, locate_world
