...
from old_files.red_ball.viam_stationary_grab import DEFAULT_CONFIG, _observe, make_targets, run_stationary_grab, validate_config
from old_files.red_ball.vision.viam_ball import BallDetection, BallPose
